...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Button class="btn btn-primary" Text="Adicionar" runat="server" ID="btnAddProduto" OnClick="BtnAddProduto_Click" />
        ...
        <ItemTemplate>
            <div class="card">
                ...
                <div class="card-footer">
                    <asp:Button class="btn btn-primary" Text="Salvar" runat="server" ID="BtnSalvar" OnClick="BtnSalvar_Click" />
                </div>
                <hr>
            </div>
        </ItemTemplate>
        ...
        <ItemTemplate>
            <div class="card">
                <div class="card-header">
                    ...
                    <asp:Label ID="lblNomeCliente" runat="server" Text='<%# Eval("NomeCliente")  %>'></asp:Label>
                    <asp:Label ID="lblDataCompra" runat="server" Text='<%# Eval("DataCompra")  %>'></asp:Label>
                    <asp:LinkButton class="btn btn-primary " ID="Editar" runat="server" CommandName="Editar" CommandArgument='<%# Eval("Codigo")  %>'>Editar</asp:LinkButton>
                    <asp:LinkButton class="btn btn-primary" ID="Desabilitar" runat="server" CommandName="Desabilitar" CommandArgument='<%# Eval("Codigo")  %>'>Desabilitar</asp:LinkButton>
                </div>
                <div class="card-body">
                    <table border="1" class="table">
                        <thead>
